	...
	Actuellement maintenu par : jastey 
...
Pour être compatible avec Glam's NPC Pack, choisissez l'option d'installation "Bérégost" pour le composant "Des loups et des hommes".
Ascalon's Questpack doit être installé avant les mods de PNJ, tout particulièrement pour Ascalon's Breagar, Brage's Redemption, et Brandock the Mage
...
Si vous rencontrez des problèmes (lors de l'installation ou dans le jeu), vous pouvez contacter le mainteneur actuel sur l'un de ces forums : Kerzenburgforum, GibberlingsThree, ou BeamDog.
...
- Corrections de typo par jazira.
...
- Aaron dira seulement que les Gnolls ont pris l'anneau, et non un chef Gnoll pour éviter toute confusion avec le chef Gnoll existant près de l'endroit où Dynaheir est détenue.
- Aaron devrait rester au Vieux Moulin après que le PC se soit reposé(e) et ne pas retourner à l'auberge.
...
- Insertion d'entrées de journal non-utilisées pour "Un travail bien payé".
- Les entrées de journal à propos des notes d'Emerson s'affichent correctement.
- L'artefact nain n'est plus accessible dans le coffre à baguette caché avant que le PJ n'ait sa clef.
- Aphriel devrait réagir à la dépouille de Perwell dès sa première rencontre.
- Aphriel initie le dialogue uniquement après que Perwell l'ait appellée.
- Perwell n'initie plus constamment un dialogue lorsqu'il est détenu dans la mine.
- Ygnazius ne devrait pas être au FAI si la quête est terminée.
- La cutscene pour recevoir le remède à la lycanthropie de Thalantyr devrait fonctionner même si le PC n'est pas dans sa demeure.
- Les Baies de Guril et les Fleurs de belladone issues des jeux originaux (BGII/SoD) peuvent aussi être utilisées comme remède à la lycanthropie. De plus, les Baies de Guril d'Ascalon's Questpack peuvent être utilisées pour la quête du tanneur dans BGII.
...
- Séparation des lignes pour l'installation dans le fichier setup-install.tra. 
- Ajout des catégories Dynamic Install Order et des LABELs uniques pour supporter Project Infinity.
